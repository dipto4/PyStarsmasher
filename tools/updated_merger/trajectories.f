      SUBROUTINE trajectories(retm1,retm2,retm3)
      INCLUDE 'spha.h'
...
c      write(24,'(d12.5,99g13.5)') T,AMb,AMg,
c     $     Xb,Yb,Zb,Xg,Yg,Zg,
c     $     dbg,am4,
c     $     abg,eccbg,
c     $     mejecta,spintotal(blue),spintotal(green),
c     $     2*pi*abg**1.5d0*(AMb+AMg)**(-0.5d0)

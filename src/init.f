...
c     initialization of run (new or restart)
     ...
     $     alphaold,betaold,trelaxold
      ...
      character*32 dirname
      character*64 restartfilename
...
c     check for existence of restart dump file:
      restartfilename = trim(dirname) // '/restartrad.sph' 
      inquire(file=restartfilename,exist=restart)
        
        print *, "restartfilename = ", restartfilename
        print *, "restartinquire = ", restart
...
c     if dump file exists, read it and restart from it:
      if(restart)then
         ...
         open(12,file=restartfilename,form='unformatted')
...
c     get 3-letter code for type of initial condition from init file
         ...
         !read(12,initt)
         !close(12)
         iname = simulationtype
         print*, "line 271, init.f: ", iname
...
************************************************************************
      ...
      print *, "line 501, init.f, displacex, displacey, displacez ="
      print *, displacex, displacey, displacez
      !ndisplace=0
      !displacex=0d0
      !displacey=0d0
      !displacez=0d0

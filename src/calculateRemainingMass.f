...
c     am(i),hp(i),rho(i),
c     $        vx(i),vy(i),vz(i),u(i),grpot(i),meanmolecular(i),cc(i)
         enddo
...
c Add above to if statement eventually          
c         print*,'pass #: ',count,'  NUMBER CHANGED = ', numchanged
      enddo 
      !write(423,*) mass0,";", mass1,";", T,";"
c      print *, 'mass0=',mass0,'mass1=',mass1,'total=',mass0+mass1
      boundmass = mass1
